...
|-------------|---------------------------------|-------------------------------------------|
| Kat Husar   | Mon, Wed, & Fri: 3:30 - 4:30 pm | Old Chem 203B                             |
| John Gillen | Sun: 10 - 11 am                 | [Zoom](https://duke.zoom.us/j/2814677671) |
...
See @sec-important-dates for date and time of the exam. Exam date cannot be changed and no make-up exam will be given. If you can't take the exam on this date, you should drop this class.
...
If there are circumstances that prevent you from completing a lab or homework assignment by the stated due date, you may email the me ([kat.husar\@duke.edu](mailto:kat.husar@duke.edu)) before the deadline to waive the late penalty. In your email, you only need to request the waiver; you do not need to provide explanation. This waiver may only be used for **once** in the semester, so only use it for a truly extenuating circumstance.
