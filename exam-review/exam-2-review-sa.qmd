...
10. \(e\) None of the above. The correct interpretation is "We are 95% confident that 40% to 90% of statistics majors work at least 5 hours per week.

11. Range of the boostrap distribution is 0.90 - 0.30 = 0.60. This spans roughly 6 standard errors. Therefore, the approximate standard error is 0.60 / 6 = 0.10.
