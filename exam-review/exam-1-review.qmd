...
d.  Slope of $R^2$ of `raise_2_fit` is higher than slope of `raise_1_fit`.
...
Show the proportions of performance ratings for hourly and salaried workers in a table and ask students to place those numbers on the segments of the plot.

## Question 12

Show a mosaicplot of the same thing and ask what additional information it provides, if any.

## Question 13

Ask a question about something mentioned in class only.

## Question 14

Ask a question about one of the keywords for class attendance quizzes.

## Question 15

Ask them to mention one concept they're struggling with.
