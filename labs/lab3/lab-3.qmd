...
1.  Go to [Duke Container Manager](https://cmgr.oit.duke.edu/containers) and create a new folder titled **lab-3 - Exploratory data analysis**.

2.  Download the files from [Canvas](https://canvas.duke.edu/courses/32831/pages/thu-may-23-regression-with-single-predictor) and upload them into the new folder you created in step 1.
