...
**Hint:** `result` is a categorical variable, so use a barplot for the visualization and the `count()` function for calculating the frequencies of *levels* of this variable.
