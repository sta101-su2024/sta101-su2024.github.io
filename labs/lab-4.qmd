...
1.  Go to [Posit Cloud](https://posit.cloud/spaces/405361) and start the project titled **lab-4 - Regression with a single predictor**.
...
::: exercise
Using `ipf_squat` from the previous exercise, create a scatter plot to investigate the relationship between squat (in lbs) and age. Age should be on the x-axis. Add a linear trend-line. Be sure to label all axes and give the plot a title. Comment on what you observe.
:::
...
::: exercise
IMS - [Chapter 5 exercises](https://openintro-ims2.netlify.app/07-model-slr#chp7-exercises), #18: Over-under, II.
:::

## Exercise 10

::: exercise
IMS - [Chapter 7 exercises](https://openintro-ims2.netlify.app/07-model-slr#chp7-exercises), #22: Body measurements, regression.
:::
...
Exercise breakdown to be posted. Total 50 points as usual.
