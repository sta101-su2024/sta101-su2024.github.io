...
- Listen to a statistics podcast (e.g., check out [Causal Inference podcast](https://casualinfer.libsyn.com/)) or watch a conference talk (e.g., a talk from [rstudio::conf(2022)](https://colorado.posit.co/rsc/conf2022-youtube-dash/))
...
::: exercise
IMS - [Chapter 19 exercises](hhttps://openintro-ims2.netlify.app/19-inference-one-mean#sec-chp19-exercises), #14: Interpreting p-values for population mean.
:::
...
::: exercise
IMS - [Chapter 19 exercises](hhttps://openintro-ims2.netlify.app/19-inference-one-mean#sec-chp19-exercises), #20: Possible bootstrap samples.
:::
