...
-   Access code: `multicollinearity` (released in class) <!-- multicollinearity -->
...
Today's daily check-in access code: `multicollinearity` (released in class) <!-- multicollinearity -->
:::
