...
-   Readings and tutorials poster for the next batch of lessons
...
Go to Canvas and open today's "quiz" titled `2023-10-18 Check-in` to vote. Access code: `___` (released in class)
:::
