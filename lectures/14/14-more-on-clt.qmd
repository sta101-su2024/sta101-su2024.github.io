...
#draw 500 random samples of size 50 
samples_50 <- matrix(rgamma(50*500,shape = 10,rate = 1/5) , 
                     nrow = 500) 
...
samples_50 <- matrix(rand_coin*rnorm(n = 50*500, mean = 22, sd = 5) + 
...
samples_150 <- matrix(rand_coin*rnorm(n = 150*500, mean = 22, sd = 5) + 
