...
plot(dsn((50-15*2):(50+15*4),50,15,alpha=8),
     main="Population Distribution - skewed",
     xlab="x",type="l",ylab="Density")
```

> Note, the mean of this distribution is around 61.87.
...
#draw 500 random samples of size 10 
samples <- matrix(rsn(10*500,50,15,alpha=8) , nrow = 500) 
...
#draw 500 random samples of size 50 
samples_50 <- matrix(rsn(50*500,50,15,alpha=8) , nrow = 500) 
...
#draw 500 random samples of size 50 
samples_150 <- matrix(rsn(150*500,50,15,alpha=8) , nrow = 500) 
...
> Note: the mean of this distribution is about 53.9.
...
#draw 500 random samples of size 10 
samples <- matrix(rbinorm(10*500,35,62,5,5,0.3) , nrow = 500) 
...
#draw 500 random samples of size 50 
samples_50 <- matrix(rbinorm(50*500,35,62,5,5,0.3) , nrow = 500) 
...
#draw 500 random samples of size 50 
samples_150 <- matrix(rbinorm(150*500,35,62,5,5,0.3) , nrow = 500) 
