...
#| label: p-value
# option 1
sum(null_dist_nc >= obs_stat)/1000
...
The p-value of 0.014 is smaller than 0.05, so we reject the null in favor of the alternative.
...
# using 2 as approximation of 1.96
c(phat - 2 * SE, phat + 2 * SE)
...
With the p-value of 0.007\<0.05, we reject the null.
